...
import 'package:app/utils/shimmer/home/all_chats/chat_page/message_receiver_item_shimmer.dart';
import 'package:app/utils/shimmer/home/all_chats/chat_page/message_sender_item_shimmer.dart';
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 24),
            MessagePageSendMessageItemShimmer(),
          ],
        ),
      ),
    );
